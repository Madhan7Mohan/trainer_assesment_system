...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .lg-root { min-height:100vh; background:#ffffff; display:flex; font-family:'DM Mono',monospace; }
  
  .lg-left { width:38%; background: linear-gradient(135deg, #0f4fd6 0%,#1e63e9 35%, #3b82f6 70%, #60a5fa 100%);border-right:1px solid rgba(0,102,204,0.1); display:flex; flex-direction:column; justify-content:center; padding:60px 48px; position:relative; overflow:hidden; flex-shrink:0; }
  .lg-left-grid { position:absolute; inset:0; background-image:none; background-size:32px 32px; }
  ...
  .lg-logo-mark { width:36px; height:36px; border:2px solid white; border-radius:8px; display:flex; align-items:center; justify-content:center; font-family:'Cabinet Grotesk',sans-serif; font-weight:800; font-size:16px; color:white; }
  .lg-logo-text { font-family:'Cabinet Grotesk',sans-serif; font-weight:800; font-size:18px; color:white; }
  .lg-welcome { position:relative; }
  .lg-welcome-tag { display:inline-block; background:white; border:1px solid black; border-radius:20px; padding:4px 14px; font-size:11px; color:black; letter-spacing:1px; text-transform:uppercase; margin-bottom:20px; }
  .lg-welcome-title { font-family:'Cabinet Grotesk',sans-serif; font-size:40px; font-weight:800; color:#ffffff; line-height:1.1; margin-bottom:16px; }
  .lg-welcome-title span { color:black; }
  .lg-welcome-desc { font-size:13px; color:white; line-height:1.7; margin-bottom:40px; }
  .lg-stats { display:flex; gap:28px; }
  .lg-stat-val { font-family:'Cabinet Grotesk',sans-serif; font-size:24px; font-weight:800; color:white; }
  .lg-stat-lbl { font-size:11px; color:black; margin-top:2px; }
  .lg-right { flex:1;  background: #f9fafb; display:flex; align-items:center; justify-content:center; padding:40px 24px; }
  .lg-card { width:100%; max-width:400px; animation:cardIn .5s cubic-bezier(.16,1,.3,1); }
  @keyframes cardIn { from{opacity:0;transform:translateY(24px)} to{opacity:1;transform:translateY(0)} }
  .lg-card-title { font-family:'Cabinet Grotesk',sans-serif; font-size:26px; font-weight:800; color:blue; margin-bottom:4px; }
  ...
  .lg-label { font-size:10px; font-weight:500; letter-spacing:1.5px; text-transform:uppercase; color:#334155; margin-bottom:6px; }
  ...
  .lg-submit { width:100%; padding:13px; background:blue; border:none; border-radius:10px; font-family:'Cabinet Grotesk',sans-serif; font-size:15px; font-weight:700; color:#fff; cursor:pointer; transition:all .2s; box-shadow:0 4px 20px rgba(0,172,193,.25); margin-top:8px; }
